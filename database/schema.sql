...
CREATE TABLE `customers` (
  ...
  `deriv_currency` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `all_deriv_accounts` json DEFAULT NULL,
  `user_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `landing_company_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `landing_company_fullname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scopes` json DEFAULT NULL,
  `is_virtual` tinyint(1) NOT NULL DEFAULT '0',
  `account_list` json DEFAULT NULL,
  ...
  `tax_residence` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
